class RootsController < ApplicationController
  ...
  before_action :authenticate_user!, only:[:index, :homepage, :butler, :create_cart]
  ...
  def create
    ...
    @blancParame.score_image = File.open('./public/assets/images/user_blanc_graph.png')
    @blancParame.save
    ...
    @rougeParame.score_image = File.open('./public/assets/images/user_rouge_graph.png')
    @rougeParame.save
    ...
    @sparklingParame.score_image = File.open('./public/assets/images/user_sparkling_graph.png')
